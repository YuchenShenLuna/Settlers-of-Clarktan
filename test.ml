...
"check_turn" >:: (fun _ -> assert_equal
  ...
  (fun _ -> assert_equal 1 (state_to_test
                            |> do_move BuyCard (Some Red)
                            |> do_move BuyCard (Some Red)
                            |> end_turn true
                            |> generate_resource 3
  ...
  (fun _ -> assert_equal 6 (state_to_test
                            |> do_move BuyCard (Some Red)
                            |> do_move BuyCard (Some Red)
                            |> end_turn true
                            |> generate_resource 3
  ...
  (fun _ -> assert_equal 0 (state_to_test
                            |> do_move BuyCard (Some Red)
                            |>do_move BuyCard (Some Red)
                            |> end_turn true
                            |> generate_resource 3
  ...
  "turn_update_green" >::
  (fun _ -> assert_equal Green (state_to_test
                                |> do_move BuyCard (Some Red)
                                |> do_move BuyCard (Some Red)
                                |> end_turn true
                                |> generate_resource 3
  ...
  "back_again_red" >::
  (fun _ -> assert_equal Red (state_to_test
                              |> do_move BuyCard (Some Red)
                              |> do_move BuyCard (Some Red)
                              |> end_turn true
                              |> generate_resource 3
